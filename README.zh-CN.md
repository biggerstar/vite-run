...
| 子命令      | 参数                       | 解释                                                 |
|----------|--------------------------|----------------------------------------------------|
|          | `<配置名称> <一个或者多个包名...>`   | 运行一个或者多个包, 例如 vite-run build appName1 appName2 ... |
|          | `-y`                     | 不跳出交互页面直接运行                                        |
| `init`   |                          | 自动生成 viterun.config 文件                             |
| `init`   | `--cover`                | 强制覆盖本地 viterun.config 文件                           |
| `init`   | `--docs`                 | 生成带文档解释的 viterun.config 文件                         |
